...
- The URL to use is https://github.com/itecrepo/addressbook.git
...
- Team -> Git -> Clone
- Set repository URL to https://github.com/itecrepo/addressbook.git
- Finish
...
- Set the repository URL to https://github.com/itecrepo/addressbook.git
